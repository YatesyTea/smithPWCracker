...
*  Copyright (c) 2014, 2018 James Smith. All rights reserved.
*/
...
#define OLDEST 0
#define YOUNGEST 1
#define LOWESTSCORE 2
#define HIGHESTSCORE 3
#define OTHER 4
...
typedef struct {
    ...
    char variableValues [N]; ///< and what  are they
    int score; ///< measure of how infeasible the solution is - more is worse for minimisation,  e.g. Password
} candidateSolution;
